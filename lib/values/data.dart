...
/*  static List<SocialData> socialData = [
  ...
  static List<ProjectItemData> recentWorks = [
    Projects.Shramic_Sandhan,
    Projects.Integrated_Market,
    Projects.DROP,
    Projects.ROAM,
...
class Projects {
  static ProjectItemData Shramic_Sandhan = ProjectItemData(
    title: StringConst.Shramic_Sandhan,
    subtitle: StringConst.Shramic_Sandhan,
  ...
  static ProjectItemData Integrated_Market = ProjectItemData(
    title: StringConst.Integrated_market,
    subtitle: StringConst.Integrated_market,
